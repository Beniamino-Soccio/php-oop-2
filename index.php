...
$croccantiniCats = new Product("croccantini", 9.89, "https://www.whiskas.it/sites/g/files/fnmzdf2106/files/2022-11/MicrosoftTeams-image%20%2811%29.png", $catsCategory, 15 );
$croccantiniDogs = new Product("croccantini", 8.57, "https://rep.grupposme.net/RepAP?code=D1446868&skey=968356899d00369a281ad152d81484e5&resize=500", $dogsCategory, 20 );
$cordaDogs = new Product("corda per cani", 15.18, "https://arcaplanet.vtexassets.com/arquivos/ids/223864/trixie-cane-gioco-corda.jpg?v=637454736645100000", $dogsCategory, 8 );
$pallinaCats = new Product("pallina per gatti", 7.83, "https://cdn.geapetshop.it/uploads/2020/09/4132.jpg", $catsCategory, 13 );
$cucciaCats = new Product("cuccia per gatti", 25.99, "https://www.bauzaar.it/media/catalog/product/g/r/grafiche-magento-bauzaar_-_2023-11-09t182512.218_1.jpg", $catsCategory, 5 );
$cucciaDogs = new Product("cuccia per cani", 27.81, "https://www.gardenhome.it/76033-large_default/cuccia-per-cane-da-esterno-con-tetto-apribile-pino-impregnato.jpg", $dogsCategory, 3 );

// string $name, float $price, string $imgUrl, Category $category, int $numberInStock
?>
